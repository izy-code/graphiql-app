# REST/GraphiQL Client team project task description:
...
- Footer should contain a link to the authors' GitHub, the year the application was created, [course logo](https://github.com/rolling-scopes-school/tasks/blob/master/react/assets/rss-logo.svg) with [link to the course](https://rs.school/react/).
